    ...
    return (
        <div className={cn("relative flex justify-center pt-10", className)}>
            <nav
                ref={navRef}
                className={cn(
                    "spotlight-nav bg-[#061428]/50 backdrop-blur-md border border-ocean/20",
            ...
            >
                ...
                {rightContent && (
                    <div className="relative z-[10] pr-2 pl-2 border-l border-ocean/20 h-6 flex items-center">
                        {rightContent}
                    </div>
                )}
        ...
        */}
            ...
            <style jsx>{`
        nav {
          --spotlight-color: rgba(0, 103, 251, 0.15);
          --ambience-color: rgba(0, 103, 251, 0.8);
        }
        :global(.dark) nav {
          --spotlight-color: rgba(0, 103, 251, 0.2);
          --ambience-color: #0067FB;
        }
      `}</style>
        </div>
    );
